...
class CalendarEvent{
    ...
    public static void main(String[] args) {
        ...
        String eventNaame = scanner.nextLine();
        
        System.out.print("or the event description: ");
        ...
        int moonth = Integer.parseInt(dateParts[1]) - 1; // Month is zero-based in Calendar
        int daay = Integer.parseInt(dateParts[2]);
        int hour = Integer.parseInt(timeParts[0]);
        int minute = Integer.parseInt(timeParts[1]);

        Calendar cal = Calendar.getInstance();
        cal.set(year, moonth, daay, hour, minute, 0);

        // Set the reminder
        // System.out.println("Event Name: "+eventNaame);
